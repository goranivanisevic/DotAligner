...
strategy is applicable for input sequences of similar lengths, however, a real
local alignment is necessary if input sequences are very long or have different
