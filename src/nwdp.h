...
extern float nwdb_align_seq_sim( char nuc_1, float probSgl_1, char nuc_2, float probSgl_2, float deltanull );
extern float nwdb_global_align_affinegaps( float* probDbl_1, float* probSgl_1, int len_1, float* probDbl_2, float* probSgl_2, int len_2, bool freeEndGaps, float ** F, float ** Q, float ** P, char ** trF, char ** trQ, char ** trP, float deltanull );
...
extern float simalign_affinegaps( float ** Z, int len_1, int len_2, int * idx_1_aln, int * idx_2_aln, int & len_pair, int & len_aln, bool global2, float ** F, float ** Q, float ** P, char ** trF, char ** trQ, char ** trP );
